...
const trendingNow = [
  ...
  { type: "WEBINAR", title: "AI in Support: From Automation to Augmentation", time: "5 days ago", icon: Video, color: "text-emerald-600", bgColor: "bg-emerald-50" },
  { type: "GUIDE", title: "The Complete Guide to Onboarding That Delivers ROI", time: "1 week ago", icon: FileText, color: "text-orange-600", bgColor: "bg-orange-50" },
  { type: "DEVELOPER DOCS", title: "Getting Started with the DexKor API", time: "1 week ago", icon: Code2, color: "text-blue-600", bgColor: "bg-blue-50" },
  { type: "REPORT", title: "2026 Customer Support Benchmarks", time: "2 weeks ago", icon: Activity, color: "text-indigo-600", bgColor: "bg-indigo-50" },
];
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-6 py-6 grid grid-cols-1 md:grid-cols-12 gap-x-10 gap-y-6">
            ...
            <div className="col-span-1 md:col-span-3 space-y-6">
              <div>
                <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">Browse Resources</h3>
                <div className="space-y-4">
                    ...
                    <div className="group cursor-pointer">
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-400">Guides, playbooks, and insights.</p>
                                </div>
                            </div>
                        ...
                        <ul className="pl-12 grid grid-cols-1 gap-2">
                            {learnLinks.map(link => (
                                <li key={link} className="text-[11px] text-slate-500 hover:text-indigo-600 cursor-pointer flex items-center gap-2">
                    ...
                    <div className="group cursor-pointer">
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-400">Docs and developer tools.</p>
                                </div>
                            </div>
                        ...
                        <ul className="pl-12 grid grid-cols-1 gap-2">
                            {techLinks.map(link => (
                                <li key={link} className="text-[11px] text-slate-500 hover:text-emerald-600 cursor-pointer flex items-center gap-2">
                                    <div className="w-1 h-1 bg-slate-200 rounded-full" />
                                    {link}
                                </li>
                            ))}
            ...
            {/* FEATURED RESOURCE */}
            <div className="col-span-1 md:col-span-6 border-x-0 md:border-x border-slate-100 px-0 md:px-10">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-6">Featured Resource</h3>
              
              <div className="bg-gradient-to-br from-[#f8f9ff] to-[#f0f2ff] rounded-3xl p-8 border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden group cursor-pointer mb-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10">
                    <div className="space-y-5">
                        <span className="text-[10px] font-bold text-indigo-600 uppercase tracking-[0.2em]">2026 Benchmark Report</span>
                        ...
                        <button className="bg-indigo-600 text-white px-7 py-3 rounded-xl text-sm font-bold flex items-center gap-3 hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-200">
                    ...
                    <div className="relative flex justify-center">
                        ...
                        <div className="w-[200px] aspect-[1/1.4] bg-[#0a0c14] rounded-2xl p-5 shadow-[0_20px_50px_rgba(0,0,0,0.3)] relative overflow-hidden transform group-hover:scale-[1.03] transition-transform duration-500">
                            ...
                            <div className="relative h-full flex flex-col justify-between">
                                ...
                                <div className="space-y-1 text-[8px] text-slate-400 font-medium">
                                    <p>500+ companies</p>
                                    <p>20+ industries</p>
                                    <p>Global insights</p>
                                </div>
                 ...
                 {[
                    ...
                    <div key={stat.label} className="text-center">
                        <div className="flex items-center justify-center gap-1 mb-1">
                            ...
                            <span className="text-[13px] font-bold text-slate-800">{stat.val}</span>
                        </div>
                        <p className="text-[8px] font-bold text-slate-400 uppercase tracking-tight">{stat.label}</p>
                    </div>
                 ))}
              </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                 <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-slate-500">Curated paths to build your expertise.</p>
                    </div>
                 </div>
                 <div className="flex flex-wrap gap-2 mb-4">
                    {learningPaths.map(path => (
                        <button key={path} className="px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-[10px] font-bold text-slate-600 hover:border-indigo-200 hover:text-indigo-600 transition-all flex items-center gap-1">
            ...
            <div className="col-span-1 md:col-span-3">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-6">Trending Now</h3>
              <div className="space-y-3">
                {trendingNow.map((item) => (
                  <div key={item.title} className="group flex items-start gap-3 p-2 rounded-xl hover:bg-slate-50 transition-all cursor-pointer">
                    ...
                    <div className="flex-1">
                        ...
                        <h5 className="text-[11px] font-bold text-slate-800 leading-tight group-hover:text-indigo-600 transition-colors">{item.title}</h5>
                ...
                <div className="flex-1 max-w-2xl w-full">
                    <div className="relative group">
                        ...
                        <input 
                            ...
                            className="w-full bg-white border border-slate-200 rounded-xl py-3 pl-12 pr-4 text-xs focus:outline-none focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100 transition-all"
                        />
                    </div>
                </div>

                <div className="flex items-center gap-8">
                    <button className="flex items-center gap-2 text-slate-600 hover:text-indigo-600 transition-colors font-bold text-xs">
