        ...
        >
            ...
            <div className="flex items-start gap-4 relative z-10">
                ...
                <div>
                    ...
                    <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 leading-tight">{subtitle}</p>
                </div>
            </div>
        </motion.div>
    );
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between gap-6 mb-2">
                <span className="text-[9px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">{title}</span>
...
const SolutionSection = () => {
  return (
    <section className="relative w-full py-16 lg:py-24 bg-white dark:bg-[#02040a] text-slate-900 dark:text-white transition-colors duration-300 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-4 z-20">
                <span className="inline-block border border-blue-200 dark:border-blue-500/30 text-blue-600 dark:text-blue-400 font-bold text-[10px] px-3 py-1 rounded-full uppercase tracking-widest mb-6">
                    — THE SOLUTION
                </span>
                
                <h2 className="text-4xl md:text-5xl font-extrabold leading-[1.1] tracking-tight text-slate-900 dark:text-white">
                    Meet DexKor.<br/>
                    One platform.<br/>
                ...
                <p className="mt-6 text-slate-600 dark:text-slate-400 text-sm leading-relaxed max-w-sm font-medium">
            ...
            <div className="lg:col-span-8 relative h-[600px] md:h-[700px] w-full flex items-center justify-center">
                ...
                >
                    ...
                    <p className="text-[10px] text-slate-500 dark:text-slate-400 text-center mt-1 mb-4 leading-tight">
                    ...
                    <div className="space-y-1.5 w-full">
                        {['Risk detected', 'Expansion identified', 'Sentiment improved', 'Workflow automated'].map((feat, i) => (
                            <div key={i} className="flex items-center gap-1.5">
                                ...
                                <span className="text-[9px] text-slate-600 dark:text-slate-300 font-medium">{feat}</span>
                            </div>
                        ))}
                    </div>
                </motion.div>
