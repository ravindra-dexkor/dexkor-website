        ...
        >
          ...
          <div className="max-w-full mx-auto px-6 py-6 grid grid-cols-1 md:grid-cols-12 gap-x-12 gap-y-8">
            ...
            <div className="col-span-1 md:col-span-4 border-l-0 md:border-l border-slate-100 dark:border-white/5 pl-0 md:pl-10">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 mb-6">Explore Customers</h3>
              
              <div className="space-y-4">
                {exploreCustomers.map((item) => (
                  <div key={item.title} className="group flex items-start gap-4 p-3 rounded-2xl hover:bg-slate-50 dark:hover:bg-white/5 transition-all cursor-pointer">
              ...
              <div className="mt-8 p-4 rounded-2xl bg-indigo-50 dark:bg-indigo-500/10/50 border border-indigo-100 flex items-center justify-between group cursor-pointer hover:bg-indigo-50 dark:bg-indigo-500/10 transition-colors">
                ...
                <div className="flex-[0.8] flex flex-col justify-between">
                    <div>
                        ...
                        <div className="flex items-center gap-8 opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-500">
                             ...
                             <div className="font-bold text-lg text-slate-800 dark:text-slate-100 tracking-tighter flex items-center gap-1">
                             ...
                             <div className="font-bold text-lg text-slate-800 dark:text-slate-100 tracking-tighter">leadsquared</div>
                        </div>
                    </div>
