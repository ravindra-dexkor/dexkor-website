            ...
            {isOpen && (
                ...
                >
                    ...
                    <div className="lg:hidden px-6 py-4 border-b border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-white/5 flex items-center justify-between">
                        ...
                        <span className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-400">Resources</span>
                    </div>
                    ...
                    <div className="max-w-full mx-auto px-6 py-6 grid grid-cols-1 md:grid-cols-12 gap-x-10 gap-y-6">
                        ...
                        <div className="col-span-1 md:col-span-3 space-y-6">
                            <div>
                                <h3 className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-400 mb-4">Browse Resources</h3>
                                <div className="space-y-4">
                                    ...
                                    <div className="group cursor-pointer">
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-700 dark:text-slate-400">Guides, playbooks, and insights.</p>
                                                </div>
                                            </div>
                                        ...
                                        <ul className="pl-12 grid grid-cols-1 gap-2">
                                            {learnLinks.map(link => (
                                                <li key={link} className="text-xs text-slate-700 dark:text-slate-400 hover:text-indigo-600 cursor-pointer flex items-center gap-2">
                                    ...
                                    <div className="group cursor-pointer">
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-700 dark:text-slate-400">Docs and developer tools.</p>
                                                </div>
                                            </div>
                                        ...
                                        <ul className="pl-12 grid grid-cols-1 gap-2">
                                            {techLinks.map(link => (
                                                <li key={link} className="text-xs text-slate-700 dark:text-slate-400 hover:text-emerald-600 cursor-pointer flex items-center gap-2">
                                                    <div className="w-1 h-1 bg-slate-200 rounded-full" />
                                                    {link}
                                                </li>
                                            ))}
                        ...
                        <div className="col-span-1 md:col-span-6 border-x-0 md:border-x border-slate-100 dark:border-white/5 px-0 md:px-10">
                            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-400 mb-6">Featured Resource</h3>
                            ...
                            <div className="grid grid-cols-4 gap-4 mb-8">
                                {[
                                    ...
                                    <div key={stat.label} className="text-center">
                                        ...
                                        <p className="text-xs font-bold text-slate-700 dark:text-slate-400 uppercase tracking-tight">{stat.label}</p>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5">
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-700 dark:text-slate-400">Curated paths to build your expertise.</p>
                                    </div>
                                </div>
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {learningPaths.map(path => (
                                        <button key={path} className="px-3 py-1.5 bg-white border border-slate-200/50 rounded-lg text-xs font-bold text-slate-700 dark:text-slate-300 hover:border-indigo-200 hover:text-indigo-600 transition-all flex items-center gap-1">
                        ...
                        <div className="col-span-1 md:col-span-3">
                            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-400 mb-6">Trending Now</h3>
                                ...
                                {trendingNow.map((item) => (
                                    <div key={item.title} className="group flex items-start gap-3 p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-all cursor-pointer">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-xs text-slate-700 dark:text-slate-400 mt-0.5">{item.time}</p>
                                        </div>
                        ...
                        <div className="max-w-full mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-6">
                            <div className="flex-1 max-w-2xl w-full">
                                <div className="relative group">
                                    <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-700 dark:text-slate-400 group-focus-within:text-indigo-600 transition-colors" />
                                    <input
                                        type="text"
                            ...
                            <div className="flex items-center gap-8">
                                <button className="flex items-center gap-2 text-slate-700 dark:text-slate-300 hover:text-indigo-600 transition-colors font-bold text-xs">
