      ...
      {isOpen && (
        ...
        >
          ...
          <div className="lg:hidden px-6 py-4 border-b border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-white/5 flex items-center justify-between">
            ...
            <span className="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-400">Solutions</span>
          </div>
          ...
          <div className="max-w-full mx-auto px-6 py-8 grid grid-cols-1 md:grid-cols-12 gap-x-12 gap-y-4">
            ...
            <div className="col-span-1 md:col-span-3">
              <h3 className="text-xs font-black uppercase tracking-[0.2em] text-slate-700 dark:text-slate-400 mb-6">BROWSE BY USE CASE</h3>
                ...
                {useCases.map((useCase) => (
                  ...
                  >
                    ...
                    <div className={cn(
                      ...
                      selectedUseCase === useCase.id ? "bg-blue-50 text-blue-600" : "bg-slate-100 dark:bg-white/5 text-slate-700 dark:text-slate-400 group-hover:text-blue-600 group-hover:bg-blue-50"
                    )}>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-700 dark:text-slate-400 mt-1 leading-tight font-medium">{useCase.description}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="col-span-1 md:col-span-9 flex flex-col">
              <h3 className="text-xs font-black uppercase tracking-[0.2em] text-slate-700 dark:text-slate-400 mb-4">EXPLORE BY INDUSTRY</h3>
                  ...
                  >
                    {/* {industry.disabled && industrySelectionEnabled && (
                      <div className="absolute top-1 right-0 left-0 text-center">
                         <span className="text-xs font-black bg-slate-200 dark:bg-white/10 text-slate-700 dark:text-slate-400 px-1.5 py-0.5 rounded uppercase tracking-widest">Coming Soon</span>
                      </div>
                    )} */}
                    <div className={cn(
                    ...
                    <span className={cn("text-xs font-black text-center uppercase tracking-tighter", selectedIndustry === industry.id && industrySelectionEnabled ? "text-blue-600" : "text-slate-700 dark:text-slate-400")}>
                      {industry.name}
                    </span>
                  </div>
                ))}
                      ...
                      <div className="grid grid-cols-3 gap-6 py-6 border-y border-slate-200/50 dark:border-white/5">
                        {activeContent.stats.map((stat: any) => (
                          <div key={stat.label}>
                            ...
                            <p className="text-xs text-slate-700 dark:text-slate-400 font-bold uppercase tracking-wider leading-tight">{stat.label}</p>
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="lg:col-span-6 relative">
                      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-white/10 overflow-hidden group-hover:scale-[1.02] transition-transform duration-700 max-h-[320px] flex flex-col">
                        <div className="p-2 border-b border-slate-200 dark:border-white/10 flex items-center justify-between bg-slate-50 dark:bg-slate-800/50 shrink-0">
                          ...
                          <span className="text-xs font-black text-slate-700 dark:text-slate-400 uppercase tracking-widest">{activeContent.imageTitle}</span>
                        </div>
            ...
            <div className="max-w-full mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-700 dark:text-slate-400 font-bold uppercase tracking-wider mt-1">Tell us about your goals and we'll recommend the right solution</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-10">
                ...
                <div className="flex items-center gap-4 border-l border-slate-200 dark:border-white/10 pl-10">
                  ...
                  <p className="text-xs font-bold text-slate-700 dark:text-slate-400 uppercase tracking-widest leading-tight">
