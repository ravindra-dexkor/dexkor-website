      ...
      {isOpen && (
        ...
        >
          ...
          <div className="lg:hidden px-6 py-4 border-b border-slate-100 bg-slate-50 flex items-center justify-between">
             ...
             <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Platform</span>
          </div>

          <div className="max-w-7xl mx-auto px-6 py-6 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-6">
            {/* CORE MODULES */}
            <div className="col-span-1 md:col-span-3">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">Core Modules</h3>
              <div className="space-y-4">
                {coreModules.map((module) => (
                  <div key={module.title} className="group flex items-start gap-3 p-2 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500 mt-0.5 leading-tight">{module.description}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* INTELLIGENCE LAYER */}
            <div className="col-span-1 md:col-span-4 border-l-0 md:border-l border-slate-100 pl-0 md:pl-8">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">Intelligence Layer</h3>
              ...
              <div className="bg-purple-50/50 rounded-xl p-3 mb-3">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-sm">Dexy AI</span>
                    <span className="text-[10px] font-bold bg-purple-200 text-purple-700 px-1.5 py-0.5 rounded uppercase">Powered by AI</span>
                  </div>
                </div>
              ...
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4 mt-6">Platform Foundation</h3>
              <div className="grid grid-cols-2 gap-y-2.5 gap-x-2">
                {platformFoundation.map((item) => (
                  <div key={item.title} className="flex items-center gap-2 group cursor-pointer">
                    <div className="w-6 h-6 bg-blue-50 rounded flex items-center justify-center group-hover:bg-blue-100 transition-colors">
            ...
            {/* PLATFORM SPOTLIGHT */}
            <div className="col-span-1 md:col-span-5 border-l-0 md:border-l border-slate-100 pl-0 md:pl-8 flex flex-col">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">Platform Spotlight</h3>
              
              <div className="flex-1 flex flex-col">
                <div className="mb-4">
                  <span className="text-[10px] font-bold bg-blue-100 text-blue-700 px-2 py-1 rounded-full uppercase">Live Preview</span>
                </div>
                ...
                <div className="mt-3 flex-1 bg-slate-50 rounded-xl border border-slate-100 overflow-hidden relative group cursor-pointer">
                  <div className="p-4 bg-white/80 backdrop-blur-sm border-b border-slate-100 flex items-center justify-between">
                     <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-red-400" />
                        <div className="w-3 h-3 rounded-full bg-yellow-400" />
                        <div className="w-3 h-3 rounded-full bg-green-400" />
                     </div>
                     <span className="text-[10px] text-slate-400 font-mono">Unified Timeline</span>
                  </div>
                  <div className="p-2">
                    {/* Placeholder for dashboard image */}
                    <div className="aspect-video bg-white rounded-lg shadow-sm border border-slate-100 flex items-center justify-center overflow-hidden">
                       <img 
                ...
                <div className="mt-4 text-center">
                   <button className="w-full bg-slate-50 hover:bg-slate-100 text-indigo-600 py-2 rounded-lg text-xs font-bold transition-colors border border-slate-100">
             ...
             <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                   ...
                   <div>
                      ...
                      <p className="text-xs text-slate-500">Built with security, scalability, and reliability at the core.</p>
                   </div>
                </div>
